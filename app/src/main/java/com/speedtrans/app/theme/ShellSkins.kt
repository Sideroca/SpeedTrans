...
object ShellSkins {
    ...
    class CutCornerDrawable(
        ...
        private fun buildPath(b: Rect) {
            ...
            path.reset()
            path.moveTo(b.left + c, b.top)
            path.lineTo(b.right - c, b.top)
            path.lineTo(b.right, b.top + c)
            path.lineTo(b.right, b.bottom - c)
            path.lineTo(b.right - c, b.bottom)
            path.lineTo(b.left + c, b.bottom)
            path.lineTo(b.left, b.bottom - c)
            path.lineTo(b.left, b.top + c)
            path.close()
        }
